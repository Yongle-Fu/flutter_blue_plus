...
final $typed_data.Uint8List bluetoothStateDescriptor = $convert.base64Decode(
    'Cg5CbHVldG9vdGhTdGF0ZRIrCgVzdGF0ZRgBIAEoDjIVLkJsdWV0b290aFN0YXRlLlN0YXRlUgVzdGF0ZSJpCgVTdGF0ZRILCgdVTktOT1dOEAASDwoLVU5BVkFJTEFCTEUQARIQCgxVTkFVVEhPUklaRUQQAhIOCgpUVVJOSU5HX09OEAMSBgoCT04QBBIPCgtUVVJOSU5HX09GRhAFEgcKA09GRhAG');
...
final $typed_data.Uint8List advertisementDataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List scanSettingsDescriptor = $convert.base64Decode(
    'CgxTY2FuU2V0dGluZ3MSKgoRYW5kcm9pZF9zY2FuX21vZGUYASABKAVSD2FuZHJvaWRTY2FuTW9kZRIjCg1zZXJ2aWNlX3V1aWRzGAIgAygJUgxzZXJ2aWNlVXVpZHMSKQoQYWxsb3dfZHVwbGljYXRlcxgDIAEoCFIPYWxsb3dEdXBsaWNhdGVz');
...
final $typed_data.Uint8List scanResultDescriptor = $convert.base64Decode(
    'CgpTY2FuUmVzdWx0EigKBmRldmljZRgBIAEoCzIQLkJsdWV0b290aERldmljZVIGZGV2aWNlEkEKEmFkdmVydGlzZW1lbnRfZGF0YRgCIAEoCzISLkFkdmVydGlzZW1lbnREYXRhUhFhZHZlcnRpc2VtZW50RGF0YRISCgRyc3NpGAMgASgFUgRyc3Np');
...
const ConnectRequest$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'connection_priority',
      '3': 3,
      '4': 1,
      '5': 5,
      '10': 'connectionPriority'
    },
...
final $typed_data.Uint8List connectRequestDescriptor = $convert.base64Decode(
    'Cg5Db25uZWN0UmVxdWVzdBIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlkEjAKFGFuZHJvaWRfYXV0b19jb25uZWN0GAIgASgIUhJhbmRyb2lkQXV0b0Nvbm5lY3QSLwoTY29ubmVjdGlvbl9wcmlvcml0eRgDIAEoBVISY29ubmVjdGlvblByaW9yaXR5EhAKA210dRgEIAEoBVIDbXR1');
...
final $typed_data.Uint8List bluetoothDeviceDescriptor = $convert.base64Decode(
    'Cg9CbHVldG9vdGhEZXZpY2USGwoJcmVtb3RlX2lkGAEgASgJUghyZW1vdGVJZBISCgRuYW1lGAIgASgJUgRuYW1lEikKBHR5cGUYAyABKA4yFS5CbHVldG9vdGhEZXZpY2UuVHlwZVIEdHlwZSIyCgRUeXBlEgsKB1VOS05PV04QABILCgdDTEFTU0lDEAESBgoCTEUQAhIICgREVUFMEAM=');
...
final $typed_data.Uint8List bluetoothServiceDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List bluetoothCharacteristicDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List bluetoothDescriptorDescriptor = $convert.base64Decode(
    'ChNCbHVldG9vdGhEZXNjcmlwdG9yEhIKBHV1aWQYASABKAlSBHV1aWQSGwoJcmVtb3RlX2lkGAIgASgJUghyZW1vdGVJZBIgCgtzZXJ2aWNlVXVpZBgDIAEoCVILc2VydmljZVV1aWQSLgoSY2hhcmFjdGVyaXN0aWNVdWlkGAQgASgJUhJjaGFyYWN0ZXJpc3RpY1V1aWQSFAoFdmFsdWUYBSABKAxSBXZhbHVl');
...
final $typed_data.Uint8List characteristicPropertiesDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List discoverServicesResultDescriptor =
    $convert.base64Decode(
        'ChZEaXNjb3ZlclNlcnZpY2VzUmVzdWx0EhsKCXJlbW90ZV9pZBgBIAEoCVIIcmVtb3RlSWQSLQoIc2VydmljZXMYAiADKAsyES5CbHVldG9vdGhTZXJ2aWNlUghzZXJ2aWNlcw==');
...
final $typed_data.Uint8List readCharacteristicRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List readCharacteristicResponseDescriptor =
    $convert.base64Decode(
        'ChpSZWFkQ2hhcmFjdGVyaXN0aWNSZXNwb25zZRIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlkEkAKDmNoYXJhY3RlcmlzdGljGAIgASgLMhguQmx1ZXRvb3RoQ2hhcmFjdGVyaXN0aWNSDmNoYXJhY3RlcmlzdGlj');
...
final $typed_data.Uint8List readDescriptorRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List readDescriptorResponseDescriptor =
    $convert.base64Decode(
        'ChZSZWFkRGVzY3JpcHRvclJlc3BvbnNlEjAKB3JlcXVlc3QYASABKAsyFi5SZWFkRGVzY3JpcHRvclJlcXVlc3RSB3JlcXVlc3QSFAoFdmFsdWUYAiABKAxSBXZhbHVl');
...
final $typed_data.Uint8List writeCharacteristicRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List writeCharacteristicResponseDescriptor =
    $convert.base64Decode(
        'ChtXcml0ZUNoYXJhY3RlcmlzdGljUmVzcG9uc2USNQoHcmVxdWVzdBgBIAEoCzIbLldyaXRlQ2hhcmFjdGVyaXN0aWNSZXF1ZXN0UgdyZXF1ZXN0EhgKB3N1Y2Nlc3MYAiABKAhSB3N1Y2Nlc3M=');
...
final $typed_data.Uint8List writeDescriptorRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List writeDescriptorResponseDescriptor =
    $convert.base64Decode(
        'ChdXcml0ZURlc2NyaXB0b3JSZXNwb25zZRIxCgdyZXF1ZXN0GAEgASgLMhcuV3JpdGVEZXNjcmlwdG9yUmVxdWVzdFIHcmVxdWVzdBIYCgdzdWNjZXNzGAIgASgIUgdzdWNjZXNz');
...
final $typed_data.Uint8List setNotificationRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List setNotificationResponseDescriptor =
    $convert.base64Decode(
        'ChdTZXROb3RpZmljYXRpb25SZXNwb25zZRIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlkEkAKDmNoYXJhY3RlcmlzdGljGAIgASgLMhguQmx1ZXRvb3RoQ2hhcmFjdGVyaXN0aWNSDmNoYXJhY3RlcmlzdGljEhgKB3N1Y2Nlc3MYAyABKAhSB3N1Y2Nlc3M=');
...
final $typed_data.Uint8List onCharacteristicChangedDescriptor =
    $convert.base64Decode(
        'ChdPbkNoYXJhY3RlcmlzdGljQ2hhbmdlZBIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlkEkAKDmNoYXJhY3RlcmlzdGljGAIgASgLMhguQmx1ZXRvb3RoQ2hhcmFjdGVyaXN0aWNSDmNoYXJhY3RlcmlzdGlj');
...
final $typed_data.Uint8List deviceStateResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List connectedDevicesResponseDescriptor =
    $convert.base64Decode(
        'ChhDb25uZWN0ZWREZXZpY2VzUmVzcG9uc2USKgoHZGV2aWNlcxgBIAMoCzIQLkJsdWV0b290aERldmljZVIHZGV2aWNlcw==');
...
final $typed_data.Uint8List mtuSizeRequestDescriptor = $convert.base64Decode(
    'Cg5NdHVTaXplUmVxdWVzdBIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlkEhAKA210dRgCIAEoDVIDbXR1');
