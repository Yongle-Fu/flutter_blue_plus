...
class BluetoothCharacteristic {
  ...
  Stream<BluetoothCharacteristic> get _onCharacteristicChangedStream =>
      FlutterBluePlugin.instance._methodStream
  ...
  Future<List<int>> read() async {
    ...
    FlutterBluePlugin.instance._log(
    ...
    return FlutterBluePlugin.instance._methodStream
  ...
  Future<Null> write(List<int> value, {bool withoutResponse = false}) async {
    ...
    var result = await FlutterBluePlugin.instance._channel
